    ...
    */
    ...
    if ($thesis_rows){
        ...
        while ($row = mysqli_fetch_assoc($thesis_rows)){
            ...
            echo "Local Thesis ID: " . $row_num . "<br>";
            ...
            //echo "<a href='thesis_edit.php' title='My Page'>edit thesis</a><br><br>";
            //echo '<input type="submit" name="edit_button'. (string)$row_num .'" value="Edit Thesis"/><br>';
            
            // edit button
            
            echo 
            '<form action="teacher.php" method="post">
            <input type="submit" name="editbutton'.$row_num.'" value="Edit Thesis"<br>
            </form>';
            ...
            echo 
            '<form action="teacher.php" method="post">
            <input type="submit" name="deletebutton'.$row_num.'" value="Delete Thesis'.$row_num.'"<br>
            </form>';
            //echo "editbutton".$row_num;
            /*
            echo "post isset: ";
